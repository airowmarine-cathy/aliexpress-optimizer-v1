...
export async function remasterImage(
  ...
  const prompt = `
    ...
    2. SUBJECT PRESERVATION (CRITICAL): The main product MUST remain EXACTLY the same shape, structure, color, and camera angle. DO NOT distort, rotate, or hallucinate new features.
    3. GROUNDING SHADOW: Add a soft, natural, and realistic drop shadow directly beneath the product to ground it. It must NOT look like it is floating in the air.
    ...
    6. LIGHTING: Ensure even, professional studio lighting. Remove harsh glares or messy environmental reflections on the product surface.
  `;
